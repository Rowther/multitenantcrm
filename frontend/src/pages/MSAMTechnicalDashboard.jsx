...
import { FileText, DollarSign, Users, TrendingUp, Plus, Calendar, PieChart as PieChartIcon, BarChartIcon, Download } from 'lucide-react';
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-slate-600 mt-2">
              {activeTab === 'dashboard' ? 'Technical Maintenance Dashboard' : 'Detailed Work Order Reports'}
            </p>
          </div>
