...
import { FileText, DollarSign, Users, TrendingUp, Plus, Car, PieChart as PieChartIcon, BarChartIcon } from 'lucide-react';
    ...
    <DashboardLayout user={user} onLogout={onLogout}>
      <div className="space-y-6" data-testid="vigor-automotive-dashboard">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-4xl font-bold text-slate-800" style={{fontFamily: 'Space Grotesk'}}>Vigor Automotive</h1>
            <p className="text-slate-600 mt-2">Automotive Workshop Dashboard</p>
          </div>
